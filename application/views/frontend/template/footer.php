...
<!-- Logout Modal-->
<div class="modal fade" id="logoutUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="<?= base_url('login_user/logout/')?>">Logout</a>
      </div>
    </div>
  </div>
</div>
...
<script src="<?= base_url('assets/') ?>js/my_javascript.js"></script>
